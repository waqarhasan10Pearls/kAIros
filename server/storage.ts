...
export class MemStorage implements IStorage {
  ...
  private initializeSimulationData() {
    ...
    const roleDescriptions = {
      daily: `In this simulation, you are the Scrum Master. Your primary accountability is to ensure the Daily Scrum happens, is effective, and stays within the 15-minute timebox. Remember that the purpose of the Daily Scrum is to inspect progress toward the Sprint Goal and adapt the Sprint Backlog as necessary. Additionally, the Developers can select whatever structure and techniques they want, as long as they focus on progress toward the Sprint Goal. I (the AI) will provide coaching and simulate team responses.`,
      planning: `In this simulation, you are the Scrum Master. You facilitate Sprint Planning, which initiates the Sprint by laying out the work to be performed for the Sprint. The event is timeboxed to a maximum of eight hours for a one-month Sprint. For shorter Sprints, the event is usually shorter. You help the team address the key topics: Why is this Sprint valuable?, What can be Done this Sprint?, and How will the chosen work get done? I (the AI) will provide coaching and simulate team responses.`,
      review: `In this simulation, you are the Scrum Master. You facilitate the Sprint Review, where the Scrum Team and stakeholders inspect the outcome of the Sprint and determine future adaptations. This is a working session and the Scrum Team presents the results of their work to key stakeholders. The event is timeboxed to a maximum of four hours for a one-month Sprint. For shorter Sprints, the event is usually shorter. I (the AI) will provide coaching and simulate team and stakeholder responses.`,
      retro: `In this simulation, you are the Scrum Master. You facilitate the Sprint Retrospective, where the purpose is to plan ways to increase quality and effectiveness. The Scrum Team inspects how the last Sprint went with regards to individuals, interactions, processes, tools, and their Definition of Done. The event is timeboxed to a maximum of three hours for a one-month Sprint. For shorter Sprints, the event is usually shorter. I (the AI) will provide coaching and simulate team responses.`
    };
  ...
  private getWelcomeMessage(eventType: string): string {
    switch(eventType) {
      ...
      case "planning":
        return `Welcome to the Sprint Planning simulation. As the Scrum Master, you'll be facilitating this Sprint Planning event. According to the Scrum Guide, Sprint Planning initiates the Sprint by laying out the work to be performed for the Sprint. This resulting plan is created by the collaborative work of the entire Scrum Team.\n\nThe event is timeboxed to a maximum of eight hours for a one-month Sprint. For shorter Sprints, the event is usually shorter.\n\nThe key topics to address are: Topic One: Why is this Sprint valuable?, Topic Two: What can be Done this Sprint?, and Topic Three: How will the chosen work get done?\n\nHow would you begin facilitating this Sprint Planning session?`;
      case "review":
        return `Welcome to the Sprint Review simulation. As the Scrum Master, you'll be facilitating this Sprint Review event. According to the Scrum Guide, the Sprint Review is a working session and the Scrum Team and stakeholders inspect the outcome of the Sprint and determine future adaptations.\n\nThe event is timeboxed to a maximum of four hours for a one-month Sprint. For shorter Sprints, the event is usually shorter.\n\nRemember, this is a working session to inspect the Increment and adapt the Product Backlog.\n\nHow would you start this Sprint Review as the Scrum Master?`;
      case "retro":
        return `Welcome to the Sprint Retrospective simulation. As the Scrum Master, you'll be facilitating this Sprint Retrospective event. According to the Scrum Guide, the purpose of the Sprint Retrospective is to plan ways to increase quality and effectiveness.\n\nThe event is timeboxed to a maximum of three hours for a one-month Sprint. For shorter Sprints, the event is usually shorter.\n\nThis is an opportunity for the Scrum Team to identify improvements for processes, interactions, and tools.\n\nHow would you begin facilitating this Retrospective session?`;
      default:
