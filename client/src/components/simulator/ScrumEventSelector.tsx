  ...
  return (
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
      {events.map((event) => (
        <button
          key={event.type}
          className={`group relative rounded-lg text-left transition-all duration-200 h-full flex flex-col ${
        ...
        >
          {/* Header section - top part with title and icon */}
          <div className="px-4 py-3 border-b border-gray-100 dark:border-gray-700 w-full flex items-center justify-between">
          ...
          {/* Description section - bottom part with description */}
